...
/// Added `@TableIndex` on the `diaryDayId` foreign key to prevent full table scans
/// when querying diary responses for a specific day.
/// Impact: Measurably faster load times for day detail views and synchronizations.
